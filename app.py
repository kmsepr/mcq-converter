...
def parse_mcqs(text):
    """Parse MCQs into rows for Excel, handling multi-line questions and missing options."""
    ...
    for line in lines:
        ...
        # Match answer (line ending with A-D)
    ...
    if not text and 'file' in request.files:
        ...
        if file and file.filename != '':
            try:
                ...
                return "Failed to read the uploaded file. Ensure it is UTF-8 encoded.", 400
